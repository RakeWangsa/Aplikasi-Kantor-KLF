                ...
                <div class="card-body">
                    ...
                    <div class="mb-1">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" name="nama" class="form-control" placeholder="Nama" style="border: 2px solid #E8C72B;" required>
                        </div>
                        <div class="mb-3">
                            <label for="nip" class="form-label text-light">Password</label>
                            <input type="password" name="password" class="form-control" placeholder="Password" style="border: 2px solid #E8C72B;" required>
                        </div>
                        <button type="submit" class="btn btn-primary w-100 mt-4" style="background-color: #E8C72B; border-color: #E8C72B;">Register</button>
                    </form>
