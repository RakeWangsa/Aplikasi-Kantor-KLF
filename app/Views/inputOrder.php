  ...
  <div class="app-content">
    ...
    <form class="text-light">
            <div class="form-group mb-2">
                ...
                <input type="text" class="form-control" id="nama" style="max-width:1000px" placeholder="Masukkan nama">
            </div>
            <div class="form-group mb-2">
                <label for="noTelfon">No Telfon:</label>
                <input type="text" class="form-control" id="noTelfon" style="max-width:1000px" placeholder="Masukkan no telfon">
            </div>
            <div class="form-group mb-2">
                <label for="alamat">Alamat:</label>
                <textarea class="form-control" id="alamat" rows="3" style="max-width:1000px" placeholder="Masukkan alamat"></textarea>
            </div>
            <div class="form-group mb-2">
            ...
            <div class="form-group mb-2">
                ...
                <select class="form-control" id="detailProdukKategori" style="max-width:1000px">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" class="form-control" id="detailProdukHarga" style="max-width:1000px" placeholder="Masukkan harga">
            </div>
            <div class="form-group mb-2">
                <label for="detailProduk">Detail Produk (Deadline):</label>
                <input type="date" class="form-control" id="detailProdukDeadline" style="max-width:1000px">
            </div>
            <div class="form-group mb-2">
                <label for="detailProduk">Detail Produk (Catatan Khusus):</label>
                <textarea class="form-control" id="detailProdukCatatan" rows="3" style="max-width:1000px" placeholder="Masukkan catatan khusus"></textarea>
            </div>
            <div class="form-group mb-2">
                <label for="kodeOrder">Kode Order:</label>
                <input type="text" class="form-control" id="kodeOrder" style="max-width:1000px" placeholder="Masukkan kode order">
            </div>
            <div class="form-group mb-2">
                <label for="invoiceCode">Invoice Code:</label>
                <input type="text" class="form-control" id="invoiceCode" style="max-width:1000px" placeholder="Masukkan invoice code">
            </div>
            <div class="form-group mb-2">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" class="form-control" id="discount" style="max-width:1000px" placeholder="Masukkan discount">
            </div>
            <div class="form-group mb-2">
                <label for="grandTotal">Grand Total:</label>
                <input type="text" class="form-control" id="grandTotal" style="max-width:1000px" placeholder="Masukkan grand total">
            </div>
